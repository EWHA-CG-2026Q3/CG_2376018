...
public class S06_ImmediateModeTriangle_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 vertexA = new Vector3(-1.5f, 0f, 0f);
    [SerializeField] private Vector3 vertexB = new Vector3(2.5f, 0f, 0f);
    [SerializeField] private Vector3 vertexC = new Vector3(0.5f, 3.2f, 0f);
