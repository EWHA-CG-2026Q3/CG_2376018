...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(40, 180);
    [SerializeField] private Vector2 vertexB = new Vector2(100, 40);
    [SerializeField] private Vector2 vertexC = new Vector2(220, 130);
    [SerializeField] private Color fillColor = new Color(0.3f, 0.7f, 1f, 1f);
